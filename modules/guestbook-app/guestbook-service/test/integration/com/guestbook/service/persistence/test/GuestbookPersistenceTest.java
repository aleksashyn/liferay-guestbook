...
import com.guestbook.exception.NoSuchGuestbookException;
import com.guestbook.model.Guestbook;
import com.guestbook.service.GuestbookLocalServiceUtil;
import com.guestbook.service.persistence.GuestbookPersistence;
import com.guestbook.service.persistence.GuestbookUtil;
...
public class GuestbookPersistenceTest {
	...
	protected OrderByComparator<Guestbook> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"GB_Guestbook", "uuid", true, "guestbookId", true, "groupId", true,
			"status", true, "statusByUserId", true, "statusByUserName", true,
			"statusDate", true, "companyId", true, "userId", true, "userName",
