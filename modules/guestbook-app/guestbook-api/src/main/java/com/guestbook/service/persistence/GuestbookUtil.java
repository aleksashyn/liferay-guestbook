...
package com.guestbook.service.persistence;
...
public class GuestbookUtil {
	...
	public static Guestbook findByUuid_First(
		...
		throws com.guestbook.exception.NoSuchGuestbookException {
